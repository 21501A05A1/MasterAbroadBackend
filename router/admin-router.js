...
router.route('/posts').get(authMiddleware,adminMiddleware,adminController.getAllPosts);
router.route('/posts/delete/:id').delete(authMiddleware,adminMiddleware,adminController.deletePostById)
